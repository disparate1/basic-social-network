...
$friendID=$row["id_friend"];
$query2="SELECT * FROM users ";
$query2.="WHERE user_id={$friendID}";
$result2=mysqli_query($connection,$query2);

$row2=mysqli_fetch_assoc($result2);
 $displayString.='<div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                  	<img src="/social-network/pictures/';
  $displayString.=$row2["user_cover"];
                  $displayString.='" class="img-responsive cover">
                  	<div class="card-info">
                      <img src="/social-network/pictures/';
                     $displayString.=$row2["user_image"];
                      $displayString.='" class="profile-photo-lg">
                      <div class="friend-info">
                        <button class="btn-warning pull-right unfriend-button" userId="';
                         $displayString.= $row2["user_id"];
                        $displayString.='">Unfriend</button>
                      	<h5><a href="/social-network/timeline.php?id=';
                        $displayString.=$row2["user_id"];
                        $displayString.='" class="profile-link">';
